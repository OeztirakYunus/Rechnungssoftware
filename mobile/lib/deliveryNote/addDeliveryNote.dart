...
class _AddDeliveryNotesState extends State<AddDeliveryNote> {
  ...
  Widget build(BuildContext context) {
    ...
    //TextEditingController clientId = TextEditingController(); // Kontakt
    //TextEditingController contactPersonId = TextEditingController(); // User
    ...
    TextEditingController productIdPosition = TextEditingController();*/
  ...
  Future<int> addDeliveryNote(
    ...
    int contactIndex = int.parse(contactPersonId);
    User contact = users.elementAt(contactIndex);
    ...
    for (int i = 0; i < quantityPosition.length; i++) {
      ...
      _positions.addAll({
        ...
        "typeOfDiscount": _delTypeOfDiscount,
